...
<template>
	<header class="border-b bg-white py-4 dark:border-zinc-900 dark:bg-neutral-900">
		<div class="container my-2 flex items-center justify-between">
			<div class="bg-secondary-500 rounded-md p-2">
				<h1 class="text-2xl text-white">VS Config Viewer</h1>
			</div>
