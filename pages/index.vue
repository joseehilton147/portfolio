...
<template>
	...
	<UxCursiveTitle text="What i do!" text-size="text-5xl" :underline-effect="true" />
	...
	<UxCursiveTitle text="Check my latest articles..." text-size="text-5xl" :underline-effect="true" />
	<div>
