...
export default defineConfig({
	...
	theme: {
		...
		colors: {
			...
			custom: {
				lavender: {
					DEFAULT: '#A06DF2', // bg-custom-lavender
					'50': '#f9f5ff', // bg-custom-lavender-50
					'100': '#f0e9fe', // bg-custom-lavender-100
					'200': '#e4d7fd', // bg-custom-lavender-200
					'300': '#cfb7fb', // bg-custom-lavender-300
					'400': '#b289f7', // bg-custom-lavender-400
					'500': '#A06DF2', // bg-custom-lavender-500
					'600': '#7d3ae3', // bg-custom-lavender-600
					'700': '#6a29c7', // bg-custom-lavender-700
					'800': '#5a26a3', // bg-custom-lavender-800
